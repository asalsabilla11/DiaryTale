...
class TodoListAdapter:RecyclerView.Adapter<TodoListAdapter.ViewHolder>() {
    ...
    interface ItemClickListener{
        fun itemCLickListener(listEntity: ListEntity,cbCondition: Boolean)
        fun btnDeleteClick(listEntity: ListEntity)
    }
    ...
    class ViewHolder(view: View): RecyclerView.ViewHolder(view){
        ...
        fun bind(listEntity: ListEntity, clickListener: ItemClickListener){
            ...
            itemView.cb_listDone_listLayout.setOnClickListener {
                ...
                clickListener.itemCLickListener(listEntity,cbCondition)
            }
            itemView.btn_deleteList_listLayout.setOnClickListener {
                clickListener.btnDeleteClick(listEntity)
            }
        }
    }

    fun todoListAdapter(todoListList: List<ListEntity>,clickListener: ItemClickListener){
